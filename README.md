...
For **a simple usage**, copy the Rscript ("entropy.R") file to the working directory where you have your aligned fasta file ("FILE_NAME.fasta") and run: 
```
...
For **a more elaborated usage** check the script "entropy_plotting.R". Recommended to open it in R-studio. 
